...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'PianoGameBuild.data';
    var REMOTE_PACKAGE_BASE = 'PianoGameBuild.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 2541956;
      var PACKAGE_UUID = '5b6303c3-3de7-494f-9025-00fcd9664b02';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 193853, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(193853, 193874, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(193874, 193991, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(193991, 1639359, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(1639359, 2514331, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(2514331, 2541956, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_PianoGameBuild.data');

    };
    Module['addRunDependency']('datafile_PianoGameBuild.data');
